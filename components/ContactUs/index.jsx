          ...
          <div className="grid grid-cols-1 min-[400px]:grid-cols-2 gap-3 w-full 2xl:w-5/6">
            <div className="flex flex-col gap-2 p-2 border border-gray-50">
                <div className="flex gap-3 items-center">
                    <span className="flex items-center justify-center p-2 bg-[#eeeeff] rounded-sm text-blue-600 text-lg"> <MdCall /> </span>
            ...
            <div className="flex flex-col gap-2 p-2 border border-gray-50">
                <div className="flex gap-3 items-center">
                    <span className="flex items-center justify-center p-2 bg-[#eeeeff] rounded-sm text-blue-600 text-lg"> <BsFillChatDotsFill /> </span>
                    <p className="flex flex-col gap-1">
            ...
            <div className="flex flex-col gap-2 p-2 border border-gray-50">
                <div className="flex gap-3 items-center">
                    <span className="flex items-center justify-center p-2 bg-[#eeeeff] rounded-sm text-blue-600 text-lg"> <BsFillChatDotsFill /> </span>
                    <p className="flex flex-col gap-1">
                        <span className="text-blue-600 font-semibold">Video Call</span>
                        <span className="text-gray-200">021 123 145 14</span>
                    </p>
                </div>
                <button className="w-full p-2 bg-[#eeeeff] text-blue-600 hover:bg-blue-800 hover:text-white rounded-sm">
            ...
            <div className="flex flex-col gap-2 p-2 border border-gray-50">
                <div className="flex gap-3 items-center">
                    <span className="flex items-center justify-center p-2 bg-[#eeeeff] rounded-sm text-blue-600 text-lg"> <MdOutlineChatBubble /> </span>
                    <p className="flex flex-col gap-1">
